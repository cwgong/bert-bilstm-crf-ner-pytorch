...
from utils import NerProcessor, convert_examples_to_features, get_Dataset,get_Pred_Dataset
...
from transformers import BertConfig,BertTokenizer,WEIGHTS_NAME,AdamW,get_linear_schedule_with_warmup

#python ner.py --model_name_or_path chinese_wwm_ext/ --do_train True --do_eval True --max_seq_length 512 --train_file dataset/train.txt --eval_file dataset/dev.txt --train_batch_size 32 --eval_batch_size 32 --num_train_epochs 10 --do_lower_case --logging_steps 200 --need_birnn True --rnn_dim 256 --clean True --output_dir model/
#python ner.py --model_name_or_path chinese_wwm_ext/ --do_test True  --max_seq_length 512 --test_file chusai_xuanshou/ --do_lower_case --logging_steps 200 --need_birnn True --rnn_dim 256 --output_dir model/
#python ner.py --model_name_or_path chinese_wwm_ext/ --do_inference True  --max_seq_length 512 --test_file dataset/train.txt  --do_lower_case --logging_steps 200 --need_birnn True --rnn_dim 256 --output_dir model/

#--model_name_or_path chinese_wwm_ext/ --do_test True  --max_seq_length 512 --test_file chusai_xuanshou/ --do_lower_case --logging_steps 200 --need_birnn True --rnn_dim 256 --output_dir model/
